...
def define_dataset(logger, opt):
    ...
    if dataset_opt['name'] == 'SEN12MS_CR_RGB':
        from .sen12ms_adapter import SEN12MS_CR_RGB
        phase_dataset = SEN12MS_CR_RGB(**dataset_opt['args'])
    else:
    ...
    if val_dataset_opt['name'] == 'SEN12MS_CR_RGB':
        from .sen12ms_adapter import SEN12MS_CR_RGB
        val_dataset = SEN12MS_CR_RGB(**val_dataset_opt['args'])
    else:
